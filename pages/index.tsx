...
export async function getServerSideProps() {
  ...
  await axios
    .get(
      "https://api.openweathermap.org/data/2.5/weather?q=Cairo&appid=009b0829f9d39cebc103cc0e0ca5be55&units=metric"
    )
    .then(async (res) => {
      await axios
        .get(
...
const Home: NextPage = ({
  ...
  useEffect(() => {
    ...
    axios
      .get(
        `https://api.openweathermap.org/data/2.5/weather?q=${city}&appid=009b0829f9d39cebc103cc0e0ca5be55&units=metric`
      )
      .then(async (res) => {
        await axios
          .get(
